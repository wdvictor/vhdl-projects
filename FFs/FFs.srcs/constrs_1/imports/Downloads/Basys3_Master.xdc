...
## Switches
#set_property PACKAGE_PIN V17 [get_ports {latch_D}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {latch_D}]
#set_property PACKAGE_PIN V16 [get_ports {latch_E}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {latch_E}]
#set_property PACKAGE_PIN W16 [get_ports {ffD_D}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {ffD_D}]
##set_property PACKAGE_PIN W17 [get_ports {sw[3]}]					
##	set_property IOSTANDARD LVCMOS33 [get_ports {sw[3]}]
#set_property PACKAGE_PIN W15 [get_ports {ff_sinc_D}]					
#	set_property IOSTANDRD LVCMOS33 [get_ports {ff_sinc_D}]
